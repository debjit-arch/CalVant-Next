...
// // ── Logging ───────────────────────────────────────────────────────────────────
// // Same relative path as RiskAssessment.js — adjust if this file's folder
// // depth under modules/taskManagement differs from modules/riskAssessment.
...
// Task Dashboard<br>IAT it . 0 total tasks Admin John ©<br>Un 0TOTAL roo WYSCOPE TASKS (OB °Penvinc Task Distribution<br>APPROVAL<br>(Cc)<br>° 0<br>APPROVED Oo | ACTIVE No Data<br>TASK Start by creating tasks<br>Quick Actions<br>8 iyos -/Each Monthlybar shows TaskNEW Creationtasks created Trendseach month (your department only)<br>Manage Tasks<br>All Tasks<br>No Trend Data<br>Tasks need date fields for trends<br>€ Back to Dashboard<br>=) Action Plan<br>+ Create Task<br>Task Management : 0 tasks shown<br>TOTAL IN PROGRESS DONE ON HOLD CRITICAL<br>STATUS PRIORITY All Priorities v |= ASSIGNEE All Assignees v Q Search tasks... 0 tasks<br># TASK SOURCE SOURCE ID ASSIGNEE REPORTER PRIORITY STATUS DUE DATE ACTIONS<br>No tasks to display.<br>+ Create a task<br><!-- End of picture text -->



// <!-- Start of picture text -->
// CreateFill in the  Tasktask details below x<br>Department *<br>Select department v<br>Assign To<br>-- Auto Assign (Risk Owner) -- v<br>Task Description *<br>Describe the task.<br>y;<br>Start Date * End Date *<br>15/07/2026 Oo dd/mm/yyyy Qa<br>Priority<br>Remarks<br>Optional notes.<br>4<br>cancel<br><!-- End of picture text -->



// <!-- Start of picture text -->
// My Tasks<br>Task Management - 14 tasks assigned to you<br>o © © ©<br>TOTAL IN PROGRESS DONE ON HOLD CRITICAL<br>STATUS e 8 To-Do e 5 In Progress Q Search tasks... 14 tasks<br>TASKID DESCRIPTION ASSIGNEE PRIORITY START DATE DUE DATE STATUS<br>1-77 CAP: When the organization determines the need for chang... ®@ Medium 09-07-2026 - © To-Do<br><!-- End of picture text -->



// <!-- Start of picture text -->
// PRIORITY STATUS DUE DATE ACTIONS<br>"Critical ~ @OnHold - 29-07-2026 & Edit X Delete<br>@ Medium - @ To-Do - 4 10-07-2026 & Edit X Delete<br>@ Medium - @ To-Do - — ®& Edit X Delete<br>@ Medium .- @ To-Do - 17-07-2026 & Edit X Delete<br>Testing DETAILS<br>STATUS<br>v Subtasks<br>e In Progress ~<br>No subtasks yet. ASSIGNEE<br>History Remarks Work Log REPORTER<br>« Remarks Updated 06 Ju! 2026, 17:18<br>DEPARTMENT<br>IT Infrastructure<br>© Status Changed 06 Jul 2026, 17:18 pRIORITY<br>= Medium<br>te-Be ~— In Progress<br>DATES<br>+ Task Created 06 Jul 2026, 16:55 Start 06-07-2026<br>End 08-07-2026<br>— - Task Initialized<br>Created: 06 Jul 2026, 16:55<br>Updated:06 Jul 2026, 17:18<br><!-- End of picture text -->
...
//     // ── LOG: fires only when user is confirmed real — mirrors RiskAssessment.js loadRiskStats ──
