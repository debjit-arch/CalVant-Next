          ...
          <div style={{ flex: 1, overflowY: "auto", padding: "24px 28px", borderRight: "1px solid #f1f5f9" }}>
            ...
            {activeTab === "history" && (
              <div style={{ position: "relative" }}>
                ...
                {logsLoading ? (
                  <div style={{ textAlign: "center", padding: 40, color: "#94a3b8" }}>Loading router...</div>
                ) : logs.length === 0 ? (
              ...
              <div>
                <div style={{ marginBottom: 8, display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                  <p style={{ margin: 0, fontSize: 12, color: "#94a3b8" }}>
                    {!hasRemarksChanged ? "✏️ Edit remarks below. Changes will be logged in router." : "⚠️ You have unsaved changes."}
                  </p>
                  {hasRemarksChanged && (
