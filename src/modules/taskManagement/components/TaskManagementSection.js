...
// // ─── Main Component ───────────────────────────────────────────
// // ALL LOGIC UNCHANGED — only UI/styling updated, plus activity logging added
...
//     // ── LOG: fires only once org context is resolved — mirrors RiskAssessment.js loadRiskStats ──
//     if (userOrgId) {
...
//     // ── LOG: status actually changed and saved ──────────────────────
//     captureActivity({
...
export default function TaskManagement({ riskFormData = {}, auditFormData = {} }) {
  ...
  const filterItems = [
    ...
    { label: "Due Soon", value: dueSoonCount, filterType: "due", filterValue: "dueSoon" },
  ];
