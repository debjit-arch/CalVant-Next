...
const PoliciesPage = () => {
  ...
  const policies = [
    // CORE & GOVERNANCE (5)
    {
      ...
      desc: "Defines principles and rules on information security management while ensuring protection of sensitive data.",
      icon: ShieldCheck,
      category: "core",
    ...
    },
    {
      ...
      desc: "Defines boundaries and extent of ISMS for ISO 27001 certification audit preparation.",
      icon: Globe,
      category: "core",
      color: "from-blue-400 to-blue-500",
      fileName: "ISMS_Scope_Document.pdf",
    },
    {
      id: 3,
      title: "ISMS Manual Template",
      desc: "Framework to design, implement, manage, and maintain effective ISMS implementation.",
      icon: FileText,
      category: "core",
      color: "from-blue-300 to-blue-400",
      fileName: "ISMS_Manual_Template.pdf",
    },
    {
      id: 4,
      title: "Security Roles & Responsibilities",
      desc: "Ensures security accountability, risk management, and security-conscious culture.",
      icon: Users,
      category: "core",
      color: "from-blue-600 to-blue-700",
      fileName: "Security_Roles_Responsibilities.pdf",
    },
    {
      id: 5,
      title: "Code of Business Conduct",
      desc: "Guides employees on behavior, communication norms, and positive work environment.",
      icon: ShieldCheck,
      category: "core",
      color: "from-blue-400 to-blue-600",
      fileName: "Code_of_Business_Conduct.pdf",
    },
    ...
    // ACCESS & IDENTITY (3)
    {
      ...
      desc: "Ensures only authorized personnel have access and appropriate permissions to critical data and systems.",
      icon: Lock,
      category: "access",
    ...
    },
    {
      ...
      desc: "Framework ensuring encryption requirements are met for safeguarding all data types.",
      icon: Lock,
      category: "access",
    ...
    },
    {
      ...
      desc: "Regulates appropriate use of digital assets and company information systems.",
      icon: Globe,
      category: "access",
      color: "from-emerald-600 to-emerald-700",
      fileName: "Acceptable_Usage_Policy.pdf",
    },
    ...
    // DATA PROTECTION (4)
    {
      ...
      desc: "Provides framework to categorize data based on sensitivity, importance, and criticality levels.",
      icon: Database,
      category: "data",
    ...
    },
    {
      ...
      desc: "Safeguards customer sensitive data and privacy while staying compliant with data protection regulations.",
      icon: Shield,
      category: "data",
    ...
    },
    {
      ...
      desc: "Guidelines for data storage, processing, management, and compliant disposal practices.",
      icon: FileText,
      category: "data",
    ...
    {
      id: 12,
      title: "Media Disposal Policy",
      desc: "Guidelines for disposal of physical/electronic media containing sensitive information.",
      icon: HardDrive,
      category: "data",
      color: "from-purple-700 to-purple-800",
      fileName: "Media_Disposal_Policy.pdf",
    },
    ...
    // INCIDENT & RESPONSE (2)
    {
      ...
      desc: "Framework to identify, respond, and resolve security incidents as fast as possible.",
      icon: AlertCircle,
      category: "incident",
      color: "from-orange-500 to-orange-600",
      fileName: "Incident_Management_Policy.pdf",
    },
    {
      id: 14,
      title: "Data Breach Notification Policy",
      desc: "Framework to identify data breach, notify authorities, and report relevant information timely.",
      icon: AlertCircle,
      category: "incident",
      color: "from-red-500 to-red-600",
      fileName: "Data_Breach_Notification_Policy.pdf",
    },
    ...
    // OPERATIONS (5)
    {
      ...
      desc: "Safeguards sensitive information during threats, vulnerabilities, change management, and disruptions.",
      icon: Activity,
      category: "operations",
      color: "from-sky-500 to-sky-600",
      fileName: "Operations_Security_Policy.pdf",
    },
    {
      id: 16,
      title: "Network Security Policy",
      desc: "Guidelines on network protection, prevention of security incidents, and safeguarding sensitive information.",
      icon: Network,
      category: "operations",
    ...
    },
    {
      ...
      desc: "Ensures systems, software, and applications stay updated with latest security patches.",
      icon: Settings,
      category: "operations",
    ...
    },
    {
      ...
      desc: "Minimizes downtime and restores business operations after security incidents or disruptions.",
      icon: Zap,
      category: "operations",
      color: "from-sky-700 to-sky-800",
      fileName: "Business_Continuity_Policy.pdf",
    },
    {
      id: 19,
      title: "Asset Management Policy",
      desc: "Optimizes resources, ensures security compliance, and minimizes data theft risks.",
      icon: Database,
      category: "operations",
      color: "from-sky-500 to-sky-600",
      fileName: "Asset_Management_Policy.pdf",
    },
    ...
    // HUMAN RESOURCES (1)
    {
      ...
      desc: "Manages HR lifecycle ensuring only authorized personnel have access to information systems.",
      icon: Users,
      category: "hr",
      color: "from-pink-500 to-pink-600",
      fileName: "HR_Security_Policy.pdf",
    },
    ...
    // RISK MANAGEMENT (2)
    {
      ...
      desc: "Actively identifies, assesses, mitigates, and remediates security risks continuously.",
      icon: BarChart3,
      category: "risk",
      color: "from-rose-500 to-rose-600",
      fileName: "Risk_Assessment_Policy.pdf",
    },
    {
      id: 22,
      title: "Compliance Policy",
      desc: "Manages compliance with legal, regulatory standards and data protection requirements.",
      icon: CheckCircle,
      category: "risk",
    ...
    // CLOUD & INFRASTRUCTURE (2)
    {
      ...
      desc: "Comprehensive guidelines for secure cloud operations, configurations, and data protection measures.",
      icon: Cloud,
      category: "cloud",
    ...
    },
    {
      ...
      desc: "Secures critical endpoint systems and minimizes security concerns across all devices.",
      icon: HardDrive,
      category: "cloud",
    ...
    // COMPLIANCE (4)
    {
      ...
      desc: "Guidelines minimizing unauthorized access to physical spaces and production environments.",
      icon: Building2,
      category: "compliance",
      color: "from-violet-500 to-violet-600",
      fileName: "Physical_Environmental_Security.pdf",
    },
    {
      id: 26,
      title: "Vendor Management Policy",
      desc: "Structured approach managing vendor relationships while mitigating third-party risks.",
      icon: Briefcase,
      category: "compliance",
    ...
    },
    {
      ...
      desc: "Guides teams implementing secure development activities and procedures throughout SDLC.",
      icon: Settings,
      category: "compliance",
      color: "from-violet-600 to-violet-700",
      fileName: "Software_Development_Lifecycle.pdf",
    },
    {
      id: 28,
      title: "System Acquisition Policy",
      desc: "Integrates security considerations into all phases of system acquisition and development.",
      icon: Server,
      category: "compliance",
      color: "from-violet-700 to-violet-800",
      fileName: "System_Acquisition_Policy.pdf",
    },
  ];
  ...
  const benefits = [
    {
      ...
      fullDesc:
        "Well-crafted policies outline necessary measures to safeguard sensitive data. They define roles and responsibilities while minimizing risks of data leakage, unauthorized access, and regulatory penalties. Legally binding agreements with external parties ensure confidentiality.",
    },
    {
      icon: Globe,
      ...
      fullDesc:
        "Avoid costly regulatory fines and penalties by demonstrating compliance with GDPR, HIPAA, and other frameworks. Our policies integrate with multiple compliance requirements, reducing the need for one-off, region-specific documentation projects.",
    },
    {
      icon: TrendingUp,
      ...
      fullDesc:
        "Streamline your sales process by reducing extensive security documentation requests (RFIs). Showcase your compliance with ISO 27001 to shorten negotiation times, close deals faster, and unlock new market opportunities.",
    },
    {
      icon: ShieldCheck,
      ...
      fullDesc:
        "Save significant time and money by preventing security breaches through proactive risk management. Implement structured controls that reduce incident likelihood, operational downtime, and associated financial losses.",
    },
    {
      icon: Users,
      ...
      fullDesc:
        "Establish clear communication of security expectations across all levels. Cross-functional involvement in policy development ensures buy-in from IT, HR, legal, and operations teams.",
    },
    {
      icon: CheckCircle,
      ...
      fullDesc:
        "All templates are auditor-approved and include evidence mapping. Real-time tracking ensures you're never caught off guard during ISO 27001 certification audits.",
    },
  ];
  ...
  const categoryInfo = {
    ...
    core: {
      ...
      count: 5,
      color: "#3b82f6",
      desc: "Foundation policies covering information security principles and governance framework",
    },
    access: {
      name: "Access & Identity",
      count: 3,
      color: "#10b981",
      desc: "Controls for authentication, authorization, and user access management",
    },
    data: {
      name: "Data Protection",
      count: 4,
      color: "#8b5cf6",
      desc: "Policies safeguarding data throughout its lifecycle - collection to disposal",
    },
    incident: {
      name: "Incident & Response",
      count: 2,
      color: "#f59e0b",
      desc: "Detection, response, and recovery procedures for security incidents",
    },
    operations: {
      name: "Operations",
      count: 5,
      color: "#0ea5e9",
      desc: "Operational security controls and system management procedures",
    },
    hr: {
      name: "Human Resources",
      count: 1,
      color: "#ec4899",
      desc: "HR security policies for employee access and lifecycle management",
    },
    risk: {
      name: "Risk Management",
      count: 2,
      color: "#f43f5e",
      desc: "Risk assessment, treatment, and continuous monitoring",
    },
    cloud: {
      name: "Cloud & Infrastructure",
      count: 2,
      color: "#64748b",
      desc: "Secure cloud operations and infrastructure management",
    },
    compliance: {
      name: "Compliance",
      count: 4,
      color: "#a855f7",
      desc: "Regulatory compliance and governance frameworks",
    },
  };
    ...
    <div className={`${styles.policiesPage} ${mounted ? styles.mounted : ""}`}>
      ...
      <section className={styles.heroSection}>
        <div className={styles.heroContent}>
          ...
          <p className={styles.heroSubtitle}>
            Download 28+ FREE, customizable, auditor-approved policy templates
            for CalVant ISMS implementation
          </p>
          <div className={styles.heroStats}>
            <div className={styles.statItem}>
              <span className={styles.statValue}>28+</span>Policies
            </div>
            <div className={styles.statItem}>
              <span className={styles.statValue}>10</span>Categories
            </div>
            <div className={styles.statItem}>
              <span className={styles.statValue}>93</span>Controls
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="policies-overview" className={styles.overviewSection}>
        <div className={styles.sectionHeader}>
          ...
          <p className={styles.sectionSubtitle}>
            Strong policies are the foundation of a robust Information Security
      ...
      <section id="policies-categories" className={styles.categoriesSection}>
        <div className={styles.sectionHeader}>
          ...
          <p className={styles.sectionSubtitle}>
            Our comprehensive templates are organized into 10 key categories
              ...
              return (
                ...
                >
                  ...
                  <div className={styles.categoryFooter}>
                    <span className={styles.categoryFooterText}>
                      Explore {info.count} policy/policies
                    </span>
                    <ChevronRight
                      size={20}
                      className={styles.categoryFooterIcon}
                    />
                  </div>
                </div>
              );
      ...
      <section id="benefits-section" className={styles.benefitsSection}>
        <div className={styles.sectionHeader}>
          <h2 className={styles.sectionTitle}>
            Key Benefits of Policy Implementation
          </h2>
          <p className={styles.sectionSubtitle}>
            Implementing comprehensive policies with CalVant delivers immediate
            and long-term value.
          </p>
        </div>
        <div className={styles.benefitsGrid}>
          {benefits.map((benefit, idx) => {
            ...
            return (
              <div
                key={idx}
                className={`${styles.benefitCard} ${expandedBenefit === idx ? styles.expanded : ""}`}
                onClick={() =>
              ...
              >
                ...
                <div className={styles.benefitContent}>
                  ...
                  {expandedBenefit === idx && (
                    <p className={styles.fullDesc}>{benefit.fullDesc}</p>
                  )}
                </div>
                <div className={styles.benefitToggle}>
                  <span>
                    {expandedBenefit === idx ? "Read less" : "Read more"}
                  </span>
                  <ChevronRight
                    size={18}
                    className={`${styles.benefitToggleSvg} ${expandedBenefit === idx ? styles.rotated : ""}`}
                  />
                </div>
              </div>
            );
      ...
      <section className={styles.ctaSection}>
        <div className={styles.ctaContent}>
          <h2 className={styles.ctaContentTitle}>
            Ready for ISO 27001 Certification?
          </h2>
          <p className={styles.ctaContentDesc}>
            Implement these templates in CalVant for automated tracking and
