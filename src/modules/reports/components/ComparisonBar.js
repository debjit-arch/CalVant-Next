        ...
        {enabled && (
          ...
          >
            <div className="flex items-center gap-3 mt-2 pt-2 border-t border-slate-100 flex-wrap">
              ...
              <span className="text-xs text-slate-500 font-medium">Comparison window</span>
              ...
              <button
                onClick={() => onChange({ enabled: true, from: defaultFrom(), to: todayStr() })}
