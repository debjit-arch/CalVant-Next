...
//   const { aiia } = useModuleEntitlements()
...
//     }
//   }
//   // Risks auto-generated by the AI Impact Assessment module are tagged
//   // with assetType "AI Asset". Only show them if the org has purchased
//   // (or is trialing) the AI Impact Assessment add-on — otherwise a tenant
//   // that only bought e.g. SOC 2 would see AI risks they never paid for.
//   const visibleRows = useMemo(() => {
//     if (aiia) return rows
//     return rows.filter((r) => r.assetType?.trim().toLowerCase() !== 'ai asset')
//   }, [rows, aiia])

//   // Create unique lists for dropdowns
//   const departments = [...new Set(visibleRows.map(r => r.department).filter(Boolean))]
//   const existingControlsList = [...new Set(visibleRows.map(r => r.existingControls).filter(Boolean))]
//   const riskTypes = [...new Set(visibleRows.map(r => r.riskType).filter(Boolean))]
//   const assetTypes = [...new Set(visibleRows.map(r => r.assetType).filter(Boolean))]
//   const assets = [...new Set(visibleRows.map(r => r.asset).filter(Boolean))]
...
//     return filtered
//   }, [visibleRows, riskIdFilter, departmentFilter, existingControlFilter, riskTypeFilter, assetTypeFilter, assetFilter, startDate, endDate, searchQuery])
...
//   const handleEdit = (id) => {
//     router.push(`/admin/risks/edit?id=${id}`)
//   }
...
//                 Showing {filteredRows.length} of {visibleRows.length} results
//               </Typography>
//             )}
//           </Box>
...
//                 <TableRow>
//                   {/* Checkbox Column */}
//                   <TableCell padding="checkbox" sx={{ position: 'sticky', left: 0, backgroundColor: '#f8fafc', borderRight: '1px solid #f1f5f9', zIndex: 4, width: '50px', verticalAlign: 'top' }}>
//                     <Checkbox
...
//                         sx={{
//                           width: '100%',
//                           '& .MuiInputBase-input': { fontSize: '12px', padding: '4px 8px', fontWeight: departmentFilter ? 700 : 400 },
//                           '& .MuiOutlinedInput-notchedOutline': departmentFilter ? { borderColor: '#2563eb', borderWidth: '1.5px' } : undefined
//                         }}
//                       >
...
//                       {/* Spacer so "Date" lines up with the filter dropdowns in the other header cells */}
//                       <Box sx={{ height: 32.75 }} />
...
//                         sx={{
//                           width: '100%',
//                           '& .MuiInputBase-input': { fontSize: '12px', padding: '4px 8px', fontWeight: riskTypeFilter ? 700 : 400 },
//                           '& .MuiOutlinedInput-notchedOutline': riskTypeFilter ? { borderColor: '#2563eb', borderWidth: '1.5px' } : undefined
//                         }}
//                       >
//                         <option value="">All</option>
//                         {riskTypes.map((type) => (
...
//                         sx={{
//                           width: '100%',
//                           '& .MuiInputBase-input': { fontSize: '12px', padding: '4px 8px', fontWeight: assetTypeFilter ? 700 : 400 },
//                           '& .MuiOutlinedInput-notchedOutline': assetTypeFilter ? { borderColor: '#2563eb', borderWidth: '1.5px' } : undefined
//                         }}
//                       >
//                         <option value="">All</option>
//                         {assetTypes.map((type) => (
...
//                         sx={{
//                           width: '100%',
//                           '& .MuiInputBase-input': { fontSize: '12px', padding: '4px 8px', fontWeight: assetFilter ? 700 : 400 },
//                           '& .MuiOutlinedInput-notchedOutline': assetFilter ? { borderColor: '#2563eb', borderWidth: '1.5px' } : undefined
//                         }}
//                       >
//                         <option value="">All</option>
//                         {assets.map((asset) => (
...
//                   <TableCell sx={{ backgroundColor: '#f8fafc', width: columnWidths.description, minWidth: columnWidths.description, maxWidth: columnWidths.description, fontWeight: 600, position: 'relative', padding: '8px', fontSize: '13px', verticalAlign: 'top' }}>
//                     <Box sx={{ position: 'relative' }}>Description<ColumnResizer columnName="description" /></Box>
//                   </TableCell>
//                   <TableCell sx={{ backgroundColor: '#f8fafc', width: columnWidths.confidentiality, minWidth: columnWidths.confidentiality, maxWidth: columnWidths.confidentiality, fontWeight: 600, position: 'relative', padding: '8px', fontSize: '13px', verticalAlign: 'top' }}>
//                     <Box sx={{ position: 'relative' }}>Confidentiality<ColumnResizer columnName="confidentiality" /></Box>
//                   </TableCell>
//                   <TableCell sx={{ backgroundColor: '#f8fafc', width: columnWidths.integrity, minWidth: columnWidths.integrity, maxWidth: columnWidths.integrity, fontWeight: 600, position: 'relative', padding: '8px', fontSize: '13px', verticalAlign: 'top' }}>
//                     <Box sx={{ position: 'relative' }}>Integrity<ColumnResizer columnName="integrity" /></Box>
//                   </TableCell>
//                   <TableCell sx={{ backgroundColor: '#f8fafc', width: columnWidths.availability, minWidth: columnWidths.availability, maxWidth: columnWidths.availability, fontWeight: 600, position: 'relative', padding: '8px', fontSize: '13px', verticalAlign: 'top' }}>
//                     <Box sx={{ position: 'relative' }}>Availability<ColumnResizer columnName="availability" /></Box>
//                   </TableCell>
//                   <TableCell sx={{ backgroundColor: '#f8fafc', width: columnWidths.probability, minWidth: columnWidths.probability, maxWidth: columnWidths.probability, fontWeight: 600, position: 'relative', padding: '8px', fontSize: '13px', verticalAlign: 'top' }}>
...
//                   <TableCell sx={{ backgroundColor: '#f8fafc', width: columnWidths.additionalNotes, minWidth: columnWidths.additionalNotes, maxWidth: columnWidths.additionalNotes, fontWeight: 600, position: 'relative', padding: '8px', fontSize: '13px', verticalAlign: 'top' }}>
//                     <Box sx={{ position: 'relative' }}>Additional Notes<ColumnResizer columnName="additionalNotes" /></Box>
//                   </TableCell>
//                   <TableCell sx={{ backgroundColor: '#f8fafc', width: columnWidths.controlRef, minWidth: columnWidths.controlRef, maxWidth: columnWidths.controlRef, fontWeight: 600, position: 'relative', padding: '8px', fontSize: '13px', verticalAlign: 'top' }}>
//                     <Box sx={{ position: 'relative' }}>Control Ref<ColumnResizer columnName="controlRef" /></Box>
//                   </TableCell>
//                   <TableCell sx={{ backgroundColor: '#f8fafc', width: columnWidths.additionalControls, minWidth: columnWidths.additionalControls, maxWidth: columnWidths.additionalControls, fontWeight: 600, position: 'relative', padding: '8px', fontSize: '13px', verticalAlign: 'top' }}>
//                     <Box sx={{ position: 'relative' }}>Add. Controls<ColumnResizer columnName="additionalControls" /></Box>
//                   </TableCell>
//                   <TableCell sx={{ backgroundColor: '#f8fafc', width: columnWidths.days, minWidth: columnWidths.days, maxWidth: columnWidths.days, fontWeight: 600, position: 'relative', padding: '8px', fontSize: '13px', verticalAlign: 'top' }}>
//                     <Box sx={{ position: 'relative' }}>Days<ColumnResizer columnName="days" /></Box>
//                   </TableCell>
//                   <TableCell sx={{ backgroundColor: '#f8fafc', width: columnWidths.deadline, minWidth: columnWidths.deadline, maxWidth: columnWidths.deadline, fontWeight: 600, position: 'relative', padding: '8px', fontSize: '13px', verticalAlign: 'top' }}>
//                     <Box sx={{ position: 'relative' }}>Deadline<ColumnResizer columnName="deadline" /></Box>
//                   </TableCell>
//                   <TableCell sx={{ backgroundColor: '#f8fafc', width: columnWidths.status, minWidth: columnWidths.status, maxWidth: columnWidths.status, fontWeight: 600, position: 'relative', padding: '8px', fontSize: '13px', verticalAlign: 'top' }}>
//                     <Box sx={{ position: 'relative' }}>Status<ColumnResizer columnName="status" /></Box>
//                   </TableCell>
//                   <TableCell sx={{ backgroundColor: '#f8fafc', width: columnWidths.riskScore, minWidth: columnWidths.riskScore, maxWidth: columnWidths.riskScore, fontWeight: 600, position: 'relative', padding: '8px', fontSize: '13px', verticalAlign: 'top' }}>
//                     <Box sx={{ position: 'relative' }}>Risk Score<ColumnResizer columnName="riskScore" /></Box>
//                   </TableCell>
//                   <TableCell sx={{ backgroundColor: '#f8fafc', width: columnWidths.riskLevel, minWidth: columnWidths.riskLevel, maxWidth: columnWidths.riskLevel, fontWeight: 600, position: 'relative', padding: '8px', fontSize: '13px', verticalAlign: 'top' }}>
//                     <Box sx={{ position: 'relative' }}>Risk Level<ColumnResizer columnName="riskLevel" /></Box>
//                   </TableCell>
//                   <TableCell sx={{ backgroundColor: '#f8fafc', width: columnWidths.likelihoodPost, minWidth: columnWidths.likelihoodPost, maxWidth: columnWidths.likelihoodPost, fontWeight: 600, position: 'relative', padding: '8px', fontSize: '13px', verticalAlign: 'top' }}>
//                     <Box sx={{ position: 'relative' }}>Likelihood (Post)<ColumnResizer columnName="likelihoodPost" /></Box>
//                   </TableCell>
//                   <TableCell sx={{ backgroundColor: '#f8fafc', width: columnWidths.impactPost, minWidth: columnWidths.impactPost, maxWidth: columnWidths.impactPost, fontWeight: 600, position: 'relative', padding: '8px', fontSize: '13px', verticalAlign: 'top' }}>
//                     <Box sx={{ position: 'relative' }}>Impact (Post)<ColumnResizer columnName="impactPost" /></Box>
//                   </TableCell>
//                   <TableCell sx={{ backgroundColor: '#f8fafc', width: columnWidths.createdAt, minWidth: columnWidths.createdAt, maxWidth: columnWidths.createdAt, fontWeight: 600, position: 'relative', padding: '8px', fontSize: '13px', verticalAlign: 'top' }}>
//                     <Box sx={{ position: 'relative' }}>Created At<ColumnResizer columnName="createdAt" /></Box>
//                   </TableCell>
//                   <TableCell sx={{ backgroundColor: '#f8fafc', width: columnWidths.updatedAt, minWidth: columnWidths.updatedAt, maxWidth: columnWidths.updatedAt, fontWeight: 600, position: 'relative', padding: '8px', fontSize: '13px', verticalAlign: 'top' }}>
...
// Shared MenuProps for every filter dropdown below.
// MUI's Select renders its menu through a Portal (attached to <body>),
// so it is no longer clipped/mis-positioned by the TableContainer's
// overflow-x:auto + sticky header combo the way a native <select>
// popup was. This is what was causing the broken/overlapping dropdown
// UI in the screenshots.
          ...
          <TableContainer sx={{ maxHeight: '70vh', overflowX: 'auto' }}>
            <Table stickyHeader size="small">
              <TableHead>
                <TableRow>
                  {/* Checkbox Column */}
                  <TableCell padding="checkbox" sx={{ position: 'sticky', top: 0, left: 0, backgroundColor: '#f8fafc', borderRight: '1px solid #f1f5f9', zIndex: 5, width: '50px', verticalAlign: 'top' }}>
                    <Checkbox
                      indeterminate={isIndeterminate}
                      checked={isAllVisibleSelected}
                      onChange={handleSelectAll}
                  ...
                  >
                    <Box sx={{ position: 'relative' }}>
                      ...
                      <TextField
                        ...
                        value={departmentFilter}
                        onChange={(e) => setDepartmentFilter(e.target.value)}
                        SelectProps={{ MenuProps: FILTER_MENU_PROPS }}
                        sx={{
                          width: '100%',
                          '& .MuiInputBase-input': { fontSize: '12px', padding: '4px 8px', fontWeight: departmentFilter ? 700 : 400 },
                          '& .MuiOutlinedInput-notchedOutline': departmentFilter ? { borderColor: '#2563eb', borderWidth: '1.5px' } : undefined
                  ...
                  {/* Other columns without filters */}
                  <TableCell sx={{ backgroundColor: '#f8fafc', width: columnWidths.description, minWidth: columnWidths.description, maxWidth: columnWidths.description, fontWeight: 600, position: 'sticky', top: 0, zIndex: 3, padding: '8px', fontSize: '13px', verticalAlign: 'top' }}>
                    <Box sx={{ position: 'relative' }}>Description<ColumnResizer columnName="description" /></Box>
                  </TableCell>
                  <TableCell sx={{ backgroundColor: '#f8fafc', width: columnWidths.confidentiality, minWidth: columnWidths.confidentiality, maxWidth: columnWidths.confidentiality, fontWeight: 600, position: 'sticky', top: 0, zIndex: 3, padding: '8px', fontSize: '13px', verticalAlign: 'top' }}>
                    <Box sx={{ position: 'relative' }}>Confidentiality<ColumnResizer columnName="confidentiality" /></Box>
                  </TableCell>
                  <TableCell sx={{ backgroundColor: '#f8fafc', width: columnWidths.integrity, minWidth: columnWidths.integrity, maxWidth: columnWidths.integrity, fontWeight: 600, position: 'sticky', top: 0, zIndex: 3, padding: '8px', fontSize: '13px', verticalAlign: 'top' }}>
                    <Box sx={{ position: 'relative' }}>Integrity<ColumnResizer columnName="integrity" /></Box>
                  </TableCell>
                  <TableCell sx={{ backgroundColor: '#f8fafc', width: columnWidths.availability, minWidth: columnWidths.availability, maxWidth: columnWidths.availability, fontWeight: 600, position: 'sticky', top: 0, zIndex: 3, padding: '8px', fontSize: '13px', verticalAlign: 'top' }}>
                    <Box sx={{ position: 'relative' }}>Availability<ColumnResizer columnName="availability" /></Box>
                  </TableCell>
                  <TableCell sx={{ backgroundColor: '#f8fafc', width: columnWidths.probability, minWidth: columnWidths.probability, maxWidth: columnWidths.probability, fontWeight: 600, position: 'sticky', top: 0, zIndex: 3, padding: '8px', fontSize: '13px', verticalAlign: 'top' }}>
                    <Box sx={{ position: 'relative' }}>Probability<ColumnResizer columnName="probability" /></Box>
                  </TableCell>
                  ...
                  >
                    <Box sx={{ position: 'relative' }}>
                      ...
                      >
                        <MenuItem value="">All</MenuItem>
                        {existingControlsList.map((ctrl) => (
                          <MenuItem key={ctrl} value={ctrl}>{ctrl}</MenuItem>
                        ))}
                      </TextField>
                      <ColumnResizer columnName="existingControls" />
                    </Box>
                  ...
                  <TableCell sx={{ backgroundColor: '#f8fafc', width: columnWidths.additionalNotes, minWidth: columnWidths.additionalNotes, maxWidth: columnWidths.additionalNotes, fontWeight: 600, position: 'sticky', top: 0, zIndex: 3, padding: '8px', fontSize: '13px', verticalAlign: 'top' }}>
                    <Box sx={{ position: 'relative' }}>Additional Notes<ColumnResizer columnName="additionalNotes" /></Box>
                  </TableCell>
                  <TableCell sx={{ backgroundColor: '#f8fafc', width: columnWidths.controlRef, minWidth: columnWidths.controlRef, maxWidth: columnWidths.controlRef, fontWeight: 600, position: 'sticky', top: 0, zIndex: 3, padding: '8px', fontSize: '13px', verticalAlign: 'top' }}>
                    <Box sx={{ position: 'relative' }}>Control Ref<ColumnResizer columnName="controlRef" /></Box>
                  </TableCell>
                  <TableCell sx={{ backgroundColor: '#f8fafc', width: columnWidths.additionalControls, minWidth: columnWidths.additionalControls, maxWidth: columnWidths.additionalControls, fontWeight: 600, position: 'sticky', top: 0, zIndex: 3, padding: '8px', fontSize: '13px', verticalAlign: 'top' }}>
                    <Box sx={{ position: 'relative' }}>Add. Controls<ColumnResizer columnName="additionalControls" /></Box>
                  </TableCell>
                  <TableCell sx={{ backgroundColor: '#f8fafc', width: columnWidths.days, minWidth: columnWidths.days, maxWidth: columnWidths.days, fontWeight: 600, position: 'sticky', top: 0, zIndex: 3, padding: '8px', fontSize: '13px', verticalAlign: 'top' }}>
                    <Box sx={{ position: 'relative' }}>Days<ColumnResizer columnName="days" /></Box>
                  </TableCell>
                  <TableCell sx={{ backgroundColor: '#f8fafc', width: columnWidths.deadline, minWidth: columnWidths.deadline, maxWidth: columnWidths.deadline, fontWeight: 600, position: 'sticky', top: 0, zIndex: 3, padding: '8px', fontSize: '13px', verticalAlign: 'top' }}>
                    <Box sx={{ position: 'relative' }}>Deadline<ColumnResizer columnName="deadline" /></Box>
                  </TableCell>
                  <TableCell sx={{ backgroundColor: '#f8fafc', width: columnWidths.status, minWidth: columnWidths.status, maxWidth: columnWidths.status, fontWeight: 600, position: 'sticky', top: 0, zIndex: 3, padding: '8px', fontSize: '13px', verticalAlign: 'top' }}>
                    <Box sx={{ position: 'relative' }}>Status<ColumnResizer columnName="status" /></Box>
                  </TableCell>
                  <TableCell sx={{ backgroundColor: '#f8fafc', width: columnWidths.riskScore, minWidth: columnWidths.riskScore, maxWidth: columnWidths.riskScore, fontWeight: 600, position: 'sticky', top: 0, zIndex: 3, padding: '8px', fontSize: '13px', verticalAlign: 'top' }}>
                    <Box sx={{ position: 'relative' }}>Risk Score<ColumnResizer columnName="riskScore" /></Box>
                  </TableCell>
                  <TableCell sx={{ backgroundColor: '#f8fafc', width: columnWidths.riskLevel, minWidth: columnWidths.riskLevel, maxWidth: columnWidths.riskLevel, fontWeight: 600, position: 'sticky', top: 0, zIndex: 3, padding: '8px', fontSize: '13px', verticalAlign: 'top' }}>
                    <Box sx={{ position: 'relative' }}>Risk Level<ColumnResizer columnName="riskLevel" /></Box>
                  </TableCell>
                  <TableCell sx={{ backgroundColor: '#f8fafc', width: columnWidths.likelihoodPost, minWidth: columnWidths.likelihoodPost, maxWidth: columnWidths.likelihoodPost, fontWeight: 600, position: 'sticky', top: 0, zIndex: 3, padding: '8px', fontSize: '13px', verticalAlign: 'top' }}>
                    <Box sx={{ position: 'relative' }}>Likelihood (Post)<ColumnResizer columnName="likelihoodPost" /></Box>
                  </TableCell>
                  <TableCell sx={{ backgroundColor: '#f8fafc', width: columnWidths.impactPost, minWidth: columnWidths.impactPost, maxWidth: columnWidths.impactPost, fontWeight: 600, position: 'sticky', top: 0, zIndex: 3, padding: '8px', fontSize: '13px', verticalAlign: 'top' }}>
                    <Box sx={{ position: 'relative' }}>Impact (Post)<ColumnResizer columnName="impactPost" /></Box>
                  </TableCell>
                  <TableCell sx={{ backgroundColor: '#f8fafc', width: columnWidths.createdAt, minWidth: columnWidths.createdAt, maxWidth: columnWidths.createdAt, fontWeight: 600, position: 'sticky', top: 0, zIndex: 3, padding: '8px', fontSize: '13px', verticalAlign: 'top' }}>
                    <Box sx={{ position: 'relative' }}>Created At<ColumnResizer columnName="createdAt" /></Box>
                  </TableCell>
                  <TableCell sx={{ backgroundColor: '#f8fafc', width: columnWidths.updatedAt, minWidth: columnWidths.updatedAt, maxWidth: columnWidths.updatedAt, fontWeight: 600, position: 'sticky', top: 0, zIndex: 3, padding: '8px', fontSize: '13px', verticalAlign: 'top' }}>
                    <Box sx={{ position: 'relative' }}>Updated At<ColumnResizer columnName="updatedAt" /></Box>
                  </TableCell>
